    ...
    def __init__(self, author: discord.Member):
        super().__init__(
            options=[
                ...
                discord.SelectOption(
                    label="Ignored Channels", emoji = None
                ),
                discord.SelectOption(
                    label="Auto Activity", emoji = None
                ),
            ]
        )
        self.author = author
...
class AutoActivity(discord.ui.Select):
    def __init__(self, author):
        ...
        options = [
            discord.SelectOption(label="Toggle", emoji = None),
            discord.SelectOption(label="Channel", emoji = None),
            discord.SelectOption(
                label="Post Date", emoji = None
            ),
        ]
        super().__init__(
