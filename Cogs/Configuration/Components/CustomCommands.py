        ...
        super().__init__(
            options=[
                discord.SelectOption(
                    label="Manage Commands", emoji = None
                ),
            ]
        )
        self.author = author
...
class ManageCommands(discord.ui.View):
    ...
    @discord.ui.button(label="Create", emoji = None)
    ...
    @discord.ui.button(label="Edit", emoji = None)
    ...
    @discord.ui.button(label="Delete", emoji = None)
