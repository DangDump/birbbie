        ...
        super().__init__(
            options=[
                discord.SelectOption(
                    label="Infraction Channel", emoji = None
                ),
                discord.SelectOption(
                ...
                discord.SelectOption(
                    label="Preset Reasons", emoji = None
                ),
            ]
        )
        self.author = author
...
class ManageReasons(discord.ui.View):
    ...
    @discord.ui.button(label="", emoji = None)
    async def AddReason(
...
class InfractionTypesAction(discord.ui.Select):
    def __init__(self, author, name):
        ...
        options = [
            discord.SelectOption(
                label="Send to channel", emoji = None
            ),
            discord.SelectOption(
                label="Required Permissions", emoji = None
            ),
            discord.SelectOption(
                label="Give Roles", emoji = None
            ),
            discord.SelectOption(
                label="Remove Roles", emoji = None
            ),
            discord.SelectOption(
                label="Staff Database Removal", emoji = None
            ),
            discord.SelectOption(
                label="Escalate", emoji = None
            ),
            discord.SelectOption(
                label="Change Group Role", emoji = None
            ),
        ]
        super().__init__(
