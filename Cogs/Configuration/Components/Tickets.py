        ...
        super().__init__(
            options=[
                discord.SelectOption(
                    label="Panels", emoji = None
                ),
                discord.SelectOption(
                    label="Multi Panels", emoji = None
                ),
                discord.SelectOption(
                    label="Quota", emoji = None
                ),
            ]
        )
        self.author = author
...
class CreateDeletePanel(discord.ui.Select):
    def __init__(self, author: discord.Member, PanelType: Literal["single", "multi"]):
        Options = [
            discord.SelectOption(label="Create", emoji = None),
            discord.SelectOption(
                label="Delete", emoji = None
            ),
            discord.SelectOption(label="Modify", emoji = None),
        ]
...
class SingelPanelCustomisation(discord.ui.View):
    ...
    @discord.ui.button(label="Customise Button", emoji = None)
...
class MultiPanelCustomisation(discord.ui.View):
    ...
    @discord.ui.button(label="Manage Panels", emoji = None)
