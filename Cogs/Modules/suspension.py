...
class Suspensions(commands.Cog):
    ...
    async def suspend(
        ...
        *,
        ...
        embed = discord.Embed(
            title="",
            description=" **TIP:** Make sure the bot has permissions to send messages to the channel & to removes roles.",
        ...
        await ctx.send(
            " Would you like to **remove roles** from this person? Don't worry the roles will be **returned** after suspension.",
            view=view,
            embed=embed,
        )
...
class RoleTakeAwayYesOrNo(discord.ui.View):
    ...
    async def Yes(self, interaction: discord.Interaction, button: discord.ui.Button):
        ...
        await interaction.response.edit_message(
            content=" Select the **roles** that will be removed & then given back after the suspension is over.",
            embed=None,
            view=view,
        )
        ...
        if suspension_record:
            ...
            if roles_removed:
                ...
                if roles_to_return and member:
                    ...
                    try:
                        await member.send(
                            f" Your suspension has been voided **@{interaction.guild.name}**"
                        )
                    except discord.Forbidden:
