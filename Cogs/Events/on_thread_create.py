...
class CloseLock(discord.ui.View):
    ...
    async def lock(self, interaction: discord.Interaction, button: discord.ui.Button):
        ...
        if self.lock.label == "Lock":
            ...
            self.lock.emoji = None
            self.lock.style = discord.ButtonStyle.green
            await thread.edit(locked=True)
            await interaction.channel.send(
                content=f" **@{interaction.user.display_name}**, has locked the thread."
            )
        else:
            ...
            await interaction.channel.send(
                content=f" **@{interaction.user.display_name}**, has unlocked the thread."
            )
    ...
    async def Close(self, interaction: discord.Interaction, button: discord.ui.Button):
        ...
        if self.Close.label == "Close":
            ...
            self.Close.emoji = None

            await interaction.channel.send(
                content=f" **@{interaction.user.display_name}**, has closed the thread.",
            ...
            await interaction.channel.send(
                content=f" **@{interaction.user.display_name}**, has reopened the thread.",
